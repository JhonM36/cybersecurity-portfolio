...
*(agregar: capturas/01-policyanalyzer-tool.png)*
...
*(agregar: capturas/07-nessus-prescan.png)*

### 8️⃣ Nessus — 22 findings informativos pre-hardening
*(agregar: capturas/08-nessus-findings.png)*
...
*(agregar: capturas/19-verify-passwords.png)*

### 2️⃣0️⃣ Verificación servicios deshabilitados
*(agregar: capturas/20-verify-services.png)*

### 2️⃣1️⃣ Verificación SMBv1 = False
*(agregar: capturas/21-verify-smb.png)*

### 2️⃣2️⃣ Verificación Firewall = True (3 perfiles)
*(agregar: capturas/22-verify-firewall.png)*

### 2️⃣3️⃣ Verificación auditoría completa
*(agregar: capturas/23-verify-audit.png)*

### 2️⃣4️⃣ Verificación LLMNR = 0
*(agregar: capturas/24-verify-llmnr.png)*

### 2️⃣5️⃣ Verificación NLA = 1
*(agregar: capturas/25-verify-nla.png)*
