...
| SIEM | Wazuh, Splunk (laboratorio) |
| Seguridad de red | Firewalls, ACLs, VPN |
...
|---|-------------|--------------|--------|
| 01 | [Análisis de Tráfico con Wireshark](./01-network-analysis/) | Wireshark | 🔄 En progreso |
| 02 | [Escaneo de Red con Nmap](./02-vulnerability-scanning/) | Nmap | 🔜 Próximamente |
